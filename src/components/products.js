    ...
    render(props) {
        ...
        const editTask=(index)=> {
            ...
            this.setState({
                ...
                imageURL:arrEntry[index].imageURL,
                edit:true
            })
            tempId=index;
            var data=JSON.parse(localStorage.getItem("Product Data"));
